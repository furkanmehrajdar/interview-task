  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-lg font-semibold text-gray-800 border-b-2 border-[#1e6bb8] pb-1 inline-block">
            Company List
          </h1>
        </div>
        <button className="bg-[#1e6bb8] hover:bg-[#0a4d8c] text-white px-4 py-2 rounded flex items-center transition-colors">
      ...
      {/* Table Header */}
      <div className="grid grid-cols-12 gap-4 px-4 py-2 bg-white rounded-t-md border-b text-sm font-medium text-gray-600">
